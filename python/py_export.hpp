...
inline void RegisterPagesPool(py::module &m) {
  ...
  py::class_<PagesPoolConf>(m, "C_PagesPoolConf")
      .def(py::init<int, size_t, size_t, const std::string &,
                    const std::string &, size_t>(),
           py::arg("device_id"), py::arg("page_nbytes"), py::arg("pool_nbytes"),
           py::arg("shm_name"), py::arg("log_prefix"), py::arg("shm_nbytes"))
  ...
  py::class_<PyPagePool>(m, "C_PagesPool")
      ...
      .def("lock", [](PyPagePool &page_pool) { return page_pool->Lock(); })
      .def("get_belong",
      ...
      .def("free_pages",
           [](PyPagePool &self, const std::vector<index_t> &pages, Belong blg,
              bip::scoped_lock<bip_mutex> &lock) {
...
inline void RegisterCachingAllocator(py::module &m) {
  ...
  py::class_<PyCachingAllocator>(m, "C_CachingAllocator")
      ...
      .def("free", [](PyCachingAllocator &self,
                      const MemBlock *block) { return self->Free(block); })
